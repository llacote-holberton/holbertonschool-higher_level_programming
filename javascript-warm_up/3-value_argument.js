...
// "Using l.e.n.g.t.h is forbidden" per task requirement
// if process.argv.l.e.n.g.t.h >= 3 console.log(process.argv[2]);
...
// const argsTotalLength = process.argv.l.e.n.g.t.h;
